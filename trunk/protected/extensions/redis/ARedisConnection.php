...
class ARedisConnection extends CApplicationComponent {
    ...
    /**
     * Gets value type hash
     * @param type $key
     * @param type $storage_id
     * @return type
     */
    public function hget($key, $storage_id) {
        return $this->getClient()->hGet($key, $storage_id);
    }

    public function hset($key, $hashkey, $value) {
        return $this->getClient()->hSet($key, $hashkey, $value);
    }
    /**
     * Gets value type sadd
     * @param type $key
     * @param type $storage_id
     * @return type
     */
