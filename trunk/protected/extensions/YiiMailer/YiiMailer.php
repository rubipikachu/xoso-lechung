...
/** 
 * Yii extension for sending emails with layouts using <a href='http://code.google.com/a/apache-extras.org/p/phpmailer/'>PHPMailer</a>
 * <h2>Configuration</h2>
 ...
 * Add this basic setting to config/mail.php, Other setttings can be found in {@link PHPMailer} class
 * <pre class="prettyprint">
 * return array(
 *     'viewPath' => 'application.views.mail', // Path to mail template directory
 ...
 *
 * <h2>Usage</h2>
 * Instantiate YiiMailer in controller and pass view and data array:
 * <pre class="prettyprint">
 *  $mail = new YiiMailer('contact', array('message'     => $model->body, 
 *                                         'name'        => $model->name, 
 *                                         'description' => 'Contact form'));
 * </pre>
 * Layout is automatically set from config but we may override it with $mail->setLayout('layoutName')
 * 
 ...
 * </pre>
 * We may use all PHPMailer properties you would usually use.
 * 
