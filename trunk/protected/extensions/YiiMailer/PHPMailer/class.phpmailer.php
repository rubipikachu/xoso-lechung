...
class PHPMailer {
   ...
   * @var string
   */
  public $From              = 'support@fshare.vn';

  /**
   * Sets the From name of the message.
   * @var string
   */
  public $FromName          = 'Support Fshare';
  ...
  */
   ...
   * @var string
   */
  public $Host          = '118.69.250.134';//'localhost';
   ...
   * @var string
   */
  public $Username      = 'support@fshare.vn';

  /**
   * Sets SMTP password.
   * @var string
   */
  public $Password      = 'abc2673c510d406098e0021e3dcd45ed5ca9f951';
