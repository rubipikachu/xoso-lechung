  ...
  <div class="panel-body">
    ...
    <table class="col-xs-12" style="font-size: 12px;">
        <tbody><tr>
            ...
            <td align="right" class="statusnam"><img src="http://lechung.nover.vn/img/loading.gif" width="16"></td>
        </tr>
        <tr>
    ...
    <table class="table" style="font-size: 10px;">
        <tbody><tr>
            ...
            <td><img src="http://lechung.nover.vn/img/loading.gif" width="16"> Đang xổ</td>
    ...
    <table class="col-xs-12" style="font-size: 12px;">
       ...
       <?php } ?>
        <tr>
         ...
         <?php } ?>
        <!--tr>
            <td align="left" width="100%" colspan="2"><img src="http://lechung.nover.vn/css/drop-dow.gif" width="15"> <span style="color: #ff0000; font-weight: bold;">Kết quả điện toán</span>
                <div class="pull-right"><img src="http://lechung.nover.vn/img/loading.gif" width="16"></div>
            </td>
        </tr-->
    </tbody></table>
    <table class="table" style="font-size: 10px;">
