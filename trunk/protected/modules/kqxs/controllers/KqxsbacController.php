...
class KqxsBacController extends AdminController
{
	...
	{
		$databac = KqxsBac::model()->findAll('1=1 order by id desc');
        $datatrung = KqxsTrung::model()->findAll('1=1 order by id desc');
        $datanam = KqxsNam::model()->findAll('1=1 order by id desc');
