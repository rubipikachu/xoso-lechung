...
<![endif]-->
  ...
  <body class="fixed-top">
        ...
        <script type="text/javascript" src="<?php echo Yii::app()->homeUrl ?>admin/assets/ckeditor/./config.js?t=D08E"></script>
        <link rel="stylesheet" type="text/css" href="<?php echo Yii::app()->homeUrl ?>admin/assets/ckeditor/skins/moono/editor.css?t=D08E">
        <script type="text/javascript" src="<?php echo Yii::app()->homeUrl ?>admin/assets/ckeditor/lang/en.js?t=D08E"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->homeUrl ?>admin/assets/ckeditor/./styles.js?t=D08E"></script>
        <script src="<?php echo Yii::app()->homeUrl ?>admin/js/jquery-1.8.3.min.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->homeUrl ?>admin/assets/ckeditor/ckeditor.js"></script>
