...
/**
 * This is the model class for table "kqxs_trung".
 *
 * The followings are the available columns in table 'kqxs_trung':
 * @property integer $id
 ...
 */
class KqxsTrung extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return KqxsTrung the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			array('provice, db, nhat, loaive, nhi, ba1, ba2, tu1, tu2, tu3, tu4, tu7, tu5, tu6, nam, sau1, sau2, sau3, bay, tam', 'safe'),
