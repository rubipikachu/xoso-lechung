    ...
    <div class="loginhome">
        <div class="container">
            ...
            <div class="col-xs-2 pull-left hidden-xs">
                <span class="pull-left"><a href="<?php echo Yii::app()->homeUrl ?>">
                    <img src="<?php echo Yii::app()->homeUrl ?>img/logo.png" height="100" /></a>
                </span>
                <span class="visible-lg pull-left"><a href="<?php echo Yii::app()->homeUrl ?>">
                    <img src="<?php echo Yii::app()->homeUrl ?>img/thantai.png" height="100" /></a>
                </span>
            </div>
            <div class="col-xs-3 pull-left visible-xs"><a href="<?php echo Yii::app()->homeUrl ?>">
                <img src="<?php echo Yii::app()->homeUrl ?>img/logo.png" height="70" /></a>
            </div>
