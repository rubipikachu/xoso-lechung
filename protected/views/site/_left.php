...
<!-- Begin chon tinh -->
<div class="panel panel-danger">
<div class="panel-heading">Kết quả xổ sô theo tỉnh</div>
<div class="panel-body">
<select class="form-control" name="tinh" onchange="if(this.value!='') window.location='/ket-qua-xo-so/'+this.value+'/ket-qua-xo-so-theo-tinh.html'">
  ...
  <div class="panel-body">
    <table class="col-xs-12" style="font-size: 12px;">
       ...
       <?php } ?>
        ...
        <!--tr>
            <td align="left" width="100%" colspan="2"><img src="<?php echo Yii::app()->homeUrl ?>css/drop-dow.gif" width="15" /> <span style="color: #ff0000; font-weight: bold;">Kết quả điện toán</span>
