...
<br />
<h3 align="center">TRỰC TIẾP XỔ SỐ MIỀN NAM <?php echo date("d-m-Y",time()) ?></h3>
<div align="center"><img src="<?php echo Yii::app()->homeUrl ?>img/xshome.gif" /></div>
<div class="tructiepnam" style="color: #C60D3C;" align="center">Xổ số sẽ bắt đầu lúc 16h12p</div>

<div class="panel panel-danger kq3" style="display: none;">
  <div class="panel-heading">Kết quả xổ số Miền Nam - <?php echo date("d-m-Y",time()) ?></div>
