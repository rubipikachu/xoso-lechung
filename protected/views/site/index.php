            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tbody>
                <tr>
                  <td>
                    <label class="nam">
                      <input type="radio" name="mut" value="mn" id="mut_0" checked="checked">
                      Miền Nam,
                    </label>
                  </td>
                  <td>
                    <label class="bac">
                      <input type="radio" name="mut" value="mb" id="mut_1">
                      Miền Bắc,
                    </label>
                  </td>
                  <td>
                    <label class="trung">
                      <input type="radio" name="mut" value="mt" id="mut_2">
                      Miền Trung
                    </label>
                  </td>
                </tr>
...
?>
<div class="panel panel-danger kq xskt<?php echo $title ?>">
...
<?php } ?>
<?php if(count($bac)>0){ ?>
<div class="panel panel-danger xsktBac">
	...
	<tbody>
		<tr>
			<td class="thu" width="100">
				<a href="/ket-qua-xo-so/mien-bac/thu-bay.html" title="Click xem tất cả KQXS Miền Bắc ngày Thứ bảy">Thứ bảy</a></td>
			<td class="ngay">
