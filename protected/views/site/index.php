...
<div class="col-xs-12 hidden-xs hidden-sm">
    <label class="radio-inline">Chọn miền: </label>
    <label class="radio-inline nam">
      <input type="radio" name="inlineRadioOptions" id="mut_0" value="option1"> Miền Nam
    </label>
    <label class="radio-inline trung">
      <input type="radio" name="inlineRadioOptions" id="mut_1" value="option2"> Miền Bắc
    </label>
    <label class="radio-inline bac">
      <input type="radio" name="inlineRadioOptions" id="mut_2" value="option3"> Miền Trung
    </label>
</div>
<div class="clearfix"></div>
...
if($jk==0){ $nam1 = $nam; $title = "Nam";}
if($jk==1){ $nam1 = $trung; $title = "Trung";}
?>
<div class="panel panel-danger kq xskt<?php echo $title ?>  hidden-xs hidden-sm">
...
<?php } ?>
<?php if(count($bac)>0){ ?>
<div class="panel panel-danger xsktBac  hidden-xs hidden-sm">
...
<?php for($jk=0;$jk<2;$jk++){ 
if($jk==0){ $nam1 = $nam; $title = "Nam";}
else if($jk==1){ $nam1 = $trung; $title = "Trung";}
?>
<div class="panel panel-danger kq xskt<?php echo $title ?>  visible-xs visible-sm">
  <div class="panel-heading">Kết Quả Xổ Số Miền <?php echo $title; ?> - <?php echo $date ?></div>
  <div class="panel-body">
...
<?php } ?>
<?php if(count($bac)>0){ ?>
<div class="panel panel-danger xsktBac  visible-xs visible-sm">
    <div class="panel-heading">Kết quả xổ số Miền Bắc - <?php echo $date ?></div>
    <div class="panel-body">
