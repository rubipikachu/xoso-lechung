...
<![endif]-->
  ...
  <body class="fixed-top">
        ...
        <script type="text/javascript" src="<?php echo Yii::app()->homeUrl ?>admin/assets/data-tables/jquery.dataTables.js"></script>
        <script type="text/javascript" src="<?php echo Yii::app()->homeUrl ?>admin/assets/data-tables/DT_bootstrap.js"></script>
